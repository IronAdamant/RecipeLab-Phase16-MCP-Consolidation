...
function loadRoutes(apiRouter, { getDb, withDb, withJson, m }) {
  ...
  [
    ...
    // Review Fifteen MCP Challenge Routes
    ['', require('./routes/reexportChainRoutes')],
    ['', require('./routes/diamondDAGRoutes')],
    ['', require('./routes/phasedScaffoldRoutes')],
    ['', require('./routes/agentSessionLockerRoutes')],
    ['', require('./routes/macroExpansionRoutes')],
    ['', require('./routes/recipeFingerprintRoutes')]
